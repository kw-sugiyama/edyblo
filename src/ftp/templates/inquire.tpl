...
<head>
	...
	<meta name="Description" content="お問い合わせ | <?=htmlspecialchars($obj_login->clientdat[0]['sc_introduce'])?>" />
	...
	<title>お問い合わせ｜<?=htmlspecialchars($obj_login->clientdat[0]['cl_jname'])?> <?=htmlspecialchars($obj_login->clientdat[0]['cl_kname'])?></title>
<?=$param_meta_robots?>
</head>
			...
			<div id="main"><!--main start-->
				...
				<div id="mainright"><!--mainright start-->
					...
					<div class="box"><!--box start-->
						<h3 class="white">お問い合わせ</h3>
					</div><!--end-->

						<form method="post" action="<?=_BLOG_SITE_URL_BASE?>inq-confirm/" name="client">
