...
<head>
	...
	<meta name="Description" content="よくあるご質問 | <?=htmlspecialchars($obj_login->clientdat[0]['sc_introduce'])?>" />
		...
		<div id="wrappertop"><!--wrappertop start -->
			...
			<div id="main"><!--main start-->
				...
				<div id="mainright"><!--mainright start-->
					...
					<p class="topicpath"><a href="<?=_BLOG_SITE_URL_BASE?>">TOP</a><span class="spacefortopicpath">&#8250;</span><?=htmlspecialchars($obj_menu->menudat[0]['mn_lname'])?></p>

						<div class="box"><!--box start-->
							<h3 class="white"><?=$obj_menu->menudat[0]['mn_lname']?></h3>
						</div><!--box end-->
							...
							<div class="box"><!--box start-->
								<table>
									<tr>
										<td>
											<p class="normallinkblue"><?=$qa_link?></p>
										</td>
									</tr>
								</table>
							</div><!--box end-->
