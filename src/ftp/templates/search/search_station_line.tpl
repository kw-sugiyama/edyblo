...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>沿線検索 | <?=$arrMetaHeader["title"]?></title>
...
<?php require_once( SYS_PATH."templates/header.tpl" ); ?>
      ...
      <div id="wrapper">
        <div id="tc_box">
          <div id="tc_right">
            <p class="topicpath"><a href="<?=_BLOG_SITE_URL_BASE?>">トップページ</a> > 沿線検索</p>
            <h3>沿線検索</h3>
            <div id="formmail-style">
              <h4>物件該当エリア</h4>
              <table class="wide">
                <form name="search_pref" method="GET" action="<?=_BLOG_SITE_URL_BASE?>search-sta/" target="_self">
                <tr>
                  <td>
<?=$arrViewData["index"]?>
                  </td>
...
<?=$arrViewData["list"]?>
                ...
                <tr>
                  <td class="noborder">
                    <div class="center"><input type="submit" value="駅名検索" /></div>
                  </td>
                </tr>
                </form>
              </table>
