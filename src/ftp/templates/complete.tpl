...
<head>
	...
	<meta name="Description" content="送信完了 | <?=htmlspecialchars($obj_login->clientdat[0]['sc_introduce'])?>" />
			...
			<div id="main"><!--main start-->
				...
				<div id="mainright"><!--mainright start-->
					...
					<div class="box"><!--box start-->
						<h3 class="white">受付の完了</h3>
					</div><!--box end-->
			
					<div class="box"><!--boxlittle start-->
						<table>
							<tr>
								<td class="padding1 bggray center">
									<p><em>受付を完了いたしました。</em></p>
								</td>
							</tr>
							<tr>
								<td class="bordergray center">
