...
// メールタイトル
$strBuffMailTitle = "";
$strBuffMailTitle = "【不動産ブログREBLO】".$arrInputData["name_kj_1"].$arrInputData["name_kj_2"]."様からのお問い合わせ";

// メール内容
$strBuffMailContents = "";
$strBuffMailContents .= $obj_login->clientdat[0]['cl_name']."　".$obj_login->clientdat[0]['cl_shiten']."　御中\n\n";
$strBuffMailContents .= "━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
$strBuffMailContents .= "不動産ブログREBLO（リブロ）にお客様よりお問合せが\n";
...
$strBuffMailContents .= "個人情報保護に関する取り扱いは充分注意するようお願いします。\n\n";
...
// メール送信処理
$ret_mail = fnc_send_mail( "INQUIRY" , $obj_login->clientdat[0]["blog_info_mail"] , $strBuffMailTitle , $strBuffMailContents );
IF( $ret_mail != 1 ){
