...
if( $_POST['mode'] == "NEW" ){
	...
	if($suc == -1){
		$obj_error->ViewErrMessage( "SYSTEM" , "ALL" , "leftmenu_main.php" , $arrOther  );
		exit;
	}
	if($suc == 2){
		$obj_error->ViewErrMessage( "DISP_NO" , "ALL" , "leftmenu_main.php" , $arrOther  );
		exit;
	}
	$message = "グループ情報を登録しました。";
