...
*/
	...
	**************************************/
	...
	$obj_cate_campain->jyoken["lm_clid"] = $_SESSION['_cl_id'];
...
echo("a");
	...
	**************************************/
	...
	$obj_cate_blog->jyoken["lm_clid"] = $_SESSION['_cl_id'];
...
echo("b");
	...
	**************************************/
	...
	$obj_cate_menu->jyoken["lm_clid"] = $_SESSION['_cl_id'];
...
echo("c");
	...
	**************************************/
	...
	$obj_cate->jyoken["lm_clid"] = $_SESSION['_cl_id'];
...
//	$lm_new_form .= "      <br>\n";
	...
	$lm_new_form .= "        <TR>\n";
	$lm_new_form .= "          <TD class=\"td_leftmenu_new\" style=\"width:120px\">状態</TD>\n";
	$lm_new_form .= "          <TD class=\"td_leftmenu_new\" style=\"width:300px\">コース情報グループ名</TD>\n";
	...
	$lm_new_form .= "          <TD class=\"td_cm\" style=\"width:120\"><input type=\"radio\" name=\"lm_stat\" value=\"1\" {$lm_statFlg1}>表示<input type=\"radio\" name=\"lm_stat\" value=\"9\" {$lm_statFlg2}>非表示</TD>\n";
...
//	$lm_new_form .= "          <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"見出し登録\" class=\"btn_leftmenu\" onclick=\"return leftmenuInputCheck( this.form , this.form )\"/></TD>\n";
	$lm_new_form .= "          <TD class=\"td_cm\" align=\"right\" style=\"width:300\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"グループ登録\" class=\"btn_leftmenu\" onclick=\"return LeftmenuInputCheck( this.form , this.form )\"/><input type=\"reset\" value=\"クリア\" class=\"btn_leftmenu\" ></TD>\n";
//	$lm_new_form .= "          <TD class=\"td_cm\" align=\"right\" style=\"width:200\"></TD>\n";
	$lm_new_form .= "      <input type=\"hidden\" name=\"lm_type\" value=\"1\">\n";
	$lm_new_form .= "      <input type=\"hidden\" name=\"cs_id\" value=\"{$_SESSION['_cl_id']}\">\n";
...
//	$lm_new_form .= "      </div>\n";
	...
	$lm_list_title .= "        <TR>\n";
	$lm_list_title .= "          <TD class=\"td_cl\" style=\"width:120px\">状態</TD>\n";
	$lm_list_title .= "          <TD class=\"td_cl\" style=\"width:300px\">コース情報グループ名</TD>\n";
	...
	for($i=0;$i<$intTotalCate;$i++){
		...
		$viewData .= "          <TD class=\"td_cm\" style=\"width:120\"><input type=\"radio\" name=\"lm_stat\" value=\"1\" {$lm_statFlg1}>表示<input type=\"radio\" name=\"lm_stat\" value=\"9\" {$lm_statFlg2}>非表示</TD>\n";
...
//		$viewData .= "          <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"見出し修正\" class=\"btn\"  onclick=\"return leftmenuInputCheck( this.form , this.form )\"/></TD>\n";
		$viewData .= "          <TD class=\"td_cm\" align=\"right\" style=\"width:300\" colspan=\"3\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"グループ名修正\" class=\"btn\" onclick=\"return LeftmenuInputCheck( this.form , this.form )\"/><INPUT type=\"button\" value=\"削除\" class=\"btn\" onclick=\"document.del_leftmenu{$i}.submit();return false;\"/><INPUT type=\"button\" value=\"カテゴリ登録\" class=\"btn\" onclick=\"document.article_leftmenu{$i}.submit();return false;\"/></TD>\n";
...
//		$viewData .= "          <TD class=\"td_cm\" align=\"right\" style=\"width:100\"></TD>\n";
		...
		$viewData .= "      <input type=\"hidden\" name=\"cs_id\" value=\"{$_SESSION['_cl_id']}\">\n";
...
//		$viewData .= "      </TR>\n";
		...
		$viewData2 .= "      <input type=\"hidden\" name=\"cs_id\" value=\"{$_SESSION['_cl_id']}\">\n";
		$viewData2 .= "      <input type=\"hidden\" name=\"lm_id\" value=\"{$lm_id}\">\n";
		...
		$viewData3 .= "      <input type=\"hidden\" name=\"cs_id\" value=\"{$_SESSION['_cl_id']}\">\n";
...
<FORM name="go_blog" method="POST" action="../blog/blog_main.php" target="_self">
    ...
    <TABLE style="width:100%">
      <TR>
        <TD style="width:20%"><IMG src="../share/images/leftmenu_title.gif" alt="左メニューグループ登録" /></TD>
...
<?=$viewData3?>
    ...
    <BR />
    <DIV id="title2">■講習・イベント情報／日記情報／基本メニュー グループ名修正</DIV>
<div id="campain">
<br>
  <table id="client" cellspacing="0">
    <tr>
      <th>講習・イベント情報グループ名</th>
      ...
      <td>
        ...
        <input type="button" value="グループ名修正" class="btn" onclick="return LeftmenuInputCheck2(this.form , this.form);">
      ...
      <td>
        <input type="hidden" name="cs_id" value="<?=$_SESSION['_cl_id']?>">
        <input type="hidden" name="lm_id" value="<?=$obj_cate_campain->leftmenudat[0]['lm_id']?>">
    ...
    <tr>
      ...
      <td>
        ...
        <input type="button" value="グループ名修正" class="btn" onclick="return LeftmenuInputCheck2(this.form , this.form);">
        <INPUT type="button" value="メニュー登録" class="btn" onclick="document.editFormmenu2.submit();return false;"/>
      </td>
        </form>
