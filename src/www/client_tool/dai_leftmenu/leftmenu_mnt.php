...
--------------------------------------------------------*/
	...
	**************************************/
	...
	$csa_new_form .= "        </TD>\n";
	$csa_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"新規作成\" class=\"btn_leftmenu\" onclick=\"return LeftmenuInputCheck( this.form , this.form )\"/></TD>\n";
