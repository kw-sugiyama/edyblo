...
==================================================*/
function zipSearch1(){
	ar_zip = document.client.ar_zip1_1.value + "-" + document.client.ar_zip1_2.value;
...
function sendDataAdd( form ){
  ...
  // 検索ワード未入力での検索は受け付けない
  if (form.address_word.value == "" || !SpaceCheck( form.address_word.value) ) {
    alert("検索ワードを入力して下さい。");
    return null;
  }
...
function sendDataAdd2( form ){
  ...
  // 検索結果を選択していない場合はエラー
  if (document.getElementById("address_list").selectedIndex == -1) {
      alert("検索結果を選択して下さい。");
      return null;
  } else if (document.getElementById("address_list").options[ document.getElementById("address_list").selectedIndex ].value == "") {
      alert("検索結果を選択して下さい。");
      return null;
  }
...
function sendDataAdd1_1( form ){
  ...
  // 検索ワード未入力での検索は受け付けない
  if (form.address_word1.value == "" || !SpaceCheck( form.address_word1.value) ) {
    alert("検索ワードを入力して下さい。");
    return null;
  }
...
function sendDataAdd1_2( form ){
  ...
  // 検索結果を選択していない場合はエラー
  if (document.getElementById("address_list1").selectedIndex == -1) {
      alert("検索結果を選択して下さい。");
      return null;
  } else if (document.getElementById("address_list1").options[ document.getElementById("address_list1").selectedIndex ].value == "") {
      alert("検索結果を選択して下さい。");
      return null;
  }
...
function sendDataAdd2_1( form ){
  ...
  // 検索ワード未入力での検索は受け付けない
  if (form.address_word2.value == "" || !SpaceCheck( form.address_word2.value) ) {
    alert("検索ワードを入力して下さい。");
    return null;
  }
...
function sendDataAdd2_2( form ){
  ...
  // 検索結果を選択していない場合はエラー
  if (document.getElementById("address_list2").selectedIndex == -1) {
      alert("検索結果を選択して下さい。");
      return null;
  } else if (document.getElementById("address_list2").options[ document.getElementById("address_list2").selectedIndex ].value == "") {
      alert("検索結果を選択して下さい。");
      return null;
  }
...
function sendDataAdd3_1( form ){
  ...
  // 検索ワード未入力での検索は受け付けない
  if (form.address_word3.value == "" || !SpaceCheck( form.address_word3.value) ) {
    alert("検索ワードを入力して下さい。");
    return null;
  }
...
function sendDataAdd3_2( form ){
  ...
  // 検索結果を選択していない場合はエラー
  if (document.getElementById("address_list3").selectedIndex == -1) {
      alert("検索結果を選択して下さい。");
      return null;
  } else if (document.getElementById("address_list3").options[ document.getElementById("address_list3").selectedIndex ].value == "") {
      alert("検索結果を選択して下さい。");
      return null;
  }
