/*=============================================================================
	...
	19. TargetValCheck( val1 , val2 )	... 指定文字かどうかチェック
...
function TellCheck_1( val )
{
	...
	ret_val = val.match(/^[0-9]{4}-([0-9]{6}|[0-9]{3}-[0-9]{3})$|^[0-9]{10}$|^([0-9]{2}((\-[0-9]{2}([0-9]{2}|[0-9]{2}\-))|([0-9]{2}\-([0-9]{2}|[0-9]{2}\-))|([0-9]{1}\-[0-9]{1}([0-9]{2}|[0-9]{2}\-))|([0-9]{3}([0-9]{1}\-|\-[0-9]{1}\-|\-[0-9]{1})))[0-9]{4})$/);
	if ( ret_val ) {
		return true;
	} else {
		return false;
...
function TellCheck_2( val )
{
	...
	ret_val = val.match(/^[0-9]{4}-([0-9]{6}|[0-9]{3}-[0-9]{3})$|^([0-9]{2}(\-[0-9]{4}|[0-9]{1}\-[0-9]{3}|[0-9]{2}\-[0-9]{2}|[0-9]{3}\-[0-9]{1})\-[0-9]{4})$/);
	if ( ret_val ) {
		return true;
	} else {
...
/*---------------------------------------------------------
    指定文字かどうかチェック
	引数　：val1   ... 入力されたデータ(例:aiueo)
		val2   ... チェックしたい正規表現(例:a-zA-Z0-9)
	返り値：true   ... 指定文字内
		false  ... 指定文字内でない
---------------------------------------------------------*/
function TargetValCheck( val1 , val2 )
{
	myRE = new RegExp( val2 );
	myRE = val2;
	ret_val = val1.match(myRE);
	if ( ret_val ) {
		return true;
	} else {
		return false;
