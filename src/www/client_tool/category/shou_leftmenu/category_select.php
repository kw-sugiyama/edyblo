...
<BODY>
  ...
  <DIV id="category">
    <DIV id="line_01">
      <FORM name="goNew" method="POST" action="./category_main.php" target="_self">
        <INPUT type="submit" value="コース情報カテゴリ" class="btn" style="width:150px">
  ...
  <DIV id="category">
    <DIV id="line_01">
      <FORM name="goNew" method="POST" action="./category_main.php" target="_self">
        <INPUT type="submit" value="スタッフ日記カテゴリ" class="btn" style="width:150px">
  ...
  <DIV id="category">
    <DIV id="line_01">
      <FORM name="goNew" method="POST" action="./category_main.php" target="_self">
        <INPUT type="submit" value="キャンペーンカテゴリ" class="btn" style="width:150px">
  ...
  <DIV id="category">
    <DIV id="line_01">
      <FORM name="goNew" method="POST" action="../menu/menu_main.php" target="_self">
        <INPUT type="submit" value="基本メニュー" class="btn" style="width:150px">
      </FORM>
    </DIV>
  </DIV>
</BODY>
