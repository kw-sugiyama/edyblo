...
if($_POST['cg_type'] == 1){
	$cg_title = "建物用カテゴリ一覧";
	$cg_title_img = "      <IMG src=\"../share/images/cate_school_title.gif\" alt=\"教室自由記事カテゴリ設定\" />";
	$cg_comment_top = "";
	$cg_list_title = "";
	...
	$cg_title = "入塾の流れ情報用カテゴリ一覧";
	$cg_title_img = "      <IMG src=\"../share/images/cate_admission_title.gif\" alt=\"入会情報カテゴリ設定\" />";
	$cg_comment_top = "";
	$cg_list_title = "";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">状態</TD>\n";
	...
	$cg_list_title = "";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">状態</TD>\n";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">リンク機能</TD>\n";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:300px\">カテゴリ名</TD>\n";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">カテゴリ表示順</TD>\n";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">&nbsp;</TD>\n";
}else if($_POST['cg_type'] == 4){
	$cg_title = "よくある質問情報用カテゴリ一覧";
	$cg_title_img = "      <IMG src=\"../share/images/cate_qa_title.gif\" alt=\"Ｑ＆Ａカテゴリ設定\" />";
	$cg_comment_top = "";
	$cg_list_title = "";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">状態</TD>\n";
	$cg_list_title .= "        <TD class=\"td_cl\" style=\"width:100px\">リンク機能</TD>\n";
...
$obj2->jyoken["cg_lmid"] = $_POST['lm_id'];
$obj2->sort["cg_dispno"] = 2;
$obj2->sort["cg_type"] = $_POST['cg_type'];
...
FOR( $i=0; $i<$num; $i++){
	...
	$cg_yobi1 = htmlspecialchars( $obj2->categorydat[$i]["cg_yobi1"] );
	if($cg_yobi1==1){
		$cg_yobi1_value = "有効";
	}else if($cg_yobi1==9){
		$cg_yobi1_value = "無効";
	...
	$viewData .= "        <TD class=\"td_cm\">{$cg_yobi1_value}</TD>\n";
	IF( $_POST['cg_type'] == 1 ){
	...
	$viewData .= "        <INPUT type=\"hidden\" name=\"lm_id\" value=\"{$_POST['lm_id']}\" />\n";
  ...
  <BODY>
    ...
    <TABLE width="700">
      ...
      <TR>
        ...
        <INPUT type="hidden" name="lm_id" value="<?=$_POST['lm_id']?>"/></TD>
