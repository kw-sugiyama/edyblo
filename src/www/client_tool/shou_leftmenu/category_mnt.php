...
$obj->jyoken["cg_lmid"] = $_POST["lm_id"];
...
if($_POST['error_mode']=="on"){
	foreach($_POST as $key => $val){
		...
		$cg_yobi1 = htmlspecialchars ($arrData["cg_yobi1"]);
		$cg_yobi2 = htmlspecialchars ($arrData["cg_yobi2"]);
		$cg_yobi3 = htmlspecialchars ($arrData["cg_yobi3"]);
		...
		if($cg_yobi1 == "1" ){
			$cg_yobi1_Check1 = " checked";
		}else if( $cg_yobi1 == "9" ){
			$cg_yobi1_Check2 = " checked";
		}
		if($cg_yobi3 == "1" ){
			$cg_yobi3_Check1 = " checked";
		}else if( $cg_yobi3 == "2" ){
			$cg_yobi3_Check2 = " checked";
		}
	if($_POST['mode'] == "EDIT"){
		...
		$strDelTag .= "            <input type=\"hidden\" name=\"lm_id\" value=\"{$_POST['lm_id']}\" />\n";
		...
		$strDelTag .= "            <input type=\"hidden\" name=\"cg_topflg\" value=\"1\" />\n";
		$strDelTag .= "          </td>\n";
		$strDelTag .= "          </form>\n";
...
//	        $dispTopValue .= "</table>\n";
	...
	if($_POST['mode'] == "EDIT"){
		...
		$cg_yobi1 = htmlspecialchars ($obj->categorydat[0]["cg_yobi1"]);
		$cg_yobi2 = htmlspecialchars ($obj->categorydat[0]["cg_yobi2"]);
		$cg_yobi3 = htmlspecialchars ($obj->categorydat[0]["cg_yobi3"]);
  ...
  <BODY>
    <div align="center">
      ...
      <table id="category" cellspacing="0">
        ...
        <tr>
          <th class="must">リンク機能</th>
          <td>
            <input type="radio" name="cg_yobi1" value="1" id="cg_yobi1_1" <?=$cg_yobi1_Check1?>/><label for="cg_yobi1_1">有効</label>
            <input type="radio" name="cg_yobi1" value="9" id="cg_yobi1_2" <?=$cg_yobi1_Check2?>/><label for="cg_yobi1_2">無効</label><br />
            <font color="#FF0000">※有効を選択すると、下記リンク先URLへのリンク機能となります。</font>
          </td>
        </tr>
        <tr>
          <th class="must">リンク先URL</th>
          <td>
            <input type="radio" name="cg_yobi3" value="1" id="cg_yobi3_1" <?=$cg_yobi3_Check1?>/><label for="cg_yobi3_1">同ウィンドウで開く</label>
            <input type="radio" name="cg_yobi3" value="2" id="cg_yobi3_2" <?=$cg_yobi3_Check2?>/><label for="cg_yobi3_2">別ウィンドウで開く</label><br />
              <input id="biko3" type="text" name="cg_yobi2" value="<?=$cg_yobi2?>" style="width:450px" onFocus='Text("biko3", 1)' onBlur='Text("biko3", 2)' />
         </td>
        </tr>
        <tr>
