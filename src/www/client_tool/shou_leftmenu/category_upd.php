...
$obj_no->jyoken["cg_clid"] = $_SESSION["_cl_id"];
$obj_no->jyoken["cg_lmid"] = $_POST["lm_id"];
...
switch( $_POST["mode"] ){
	case 'NEW':
		...
		$obj_new->categorydat[0]["cg_clid"] = $_SESSION["_cl_id"];
		$obj_new->categorydat[0]["cg_lmid"] = $_POST["lm_id"];
		$obj_new->categorydat[0]["cg_stat"] = $_POST["cg_stat"];
		$obj_new->categorydat[0]["cg_yobi1"] = $_POST["cg_yobi1"];
		$obj_new->categorydat[0]["cg_yobi2"] = $_POST["cg_yobi2"];
		$obj_new->categorydat[0]["cg_yobi3"] = $_POST["cg_yobi3"];
	...
	case 'EDIT':
		...
		$obj_rev->categorydat[0]["cg_clid"] = $_SESSION["_cl_id"];
		$obj_rev->categorydat[0]["cg_lmid"] = $_POST["lm_id"];
		$obj_rev->categorydat[0]["cg_type"] = $_POST["cg_type"];
		$obj_rev->categorydat[0]["cg_stat"] = $_POST["cg_stat"];
		$obj_rev->categorydat[0]["cg_yobi1"] = $_POST["cg_yobi1"];
		$obj_rev->categorydat[0]["cg_yobi2"] = $_POST["cg_yobi2"];
		$obj_rev->categorydat[0]["cg_yobi3"] = $_POST["cg_yobi3"];
