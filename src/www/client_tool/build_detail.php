...
require_once( SYS_PATH."php/disp_build_detail.php" );


// 部屋情報詳細ページ用左側生成
//    => アイコン・同建物の別部屋情報を生成
//    => 生成値は $arrViewBuildLeft に格納
require_once( SYS_PATH."php/disp_build_left.php" );
...
/*-------------------------------------------
   ベーステンプレート表示
-------------------------------------------*/
include( SYS_PATH."templates/build_detail.tpl" );
