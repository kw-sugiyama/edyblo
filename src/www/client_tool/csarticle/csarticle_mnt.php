...
--------------------------------------------------------*/
	...
	**************************************/
	// カテゴリ情報生成
	$csa_cateid = $obj2->csarticledat[$i]['csa_cateid'];
	...
	$csa_new_form = "";
	$csa_new_form .= "        <img src=\"../share/images/csarticle_new_button.gif\" alt=\"こちらをクリックすると展開表示できます\" width=\"100\" height=\"20\" title=\"詳細条件検索で絞り込む\" />\n";
	...
	$csa_new_form .= "      <table border=\"0\" style=\"border:solid thin\" rules=\"none\">\n";
	$csa_new_form .= "      <TR>\n";
	$csa_new_form .= "        <FORM method=\"POST\" action=\"csarticle_upd.php\" target=\"_self\" name=\"editForm\" id=\"editForm\" enctype=\"multipart/form-data\">\n";
	...
	$csa_new_form .= "        </TD>\n";
	$csa_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><INPUT type=\"submit\" name=\"go_mnt_2\" value=\"新規作成\" class=\"btn_csarticle\" onclick=\"return CsarticleInputCheck( this.form , this.form )\"/></TD>\n";
	$csa_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><input type=\"reset\" value=\"クリア\" class=\"btn_csarticle\" ></TD>\n";
	$csa_new_form .= "      </TR>\n";
	$csa_new_form .= "      <TR>\n";
...
//	$csa_new_form .= "      <br>\n";
	$csa_new_form .= "      <table border=\"0\" style=\"border:solid thin\" rules=\"none\">\n";
	$csa_new_form .= "        <TR>\n";
	$csa_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:350px\">状態</TD>\n";
	$csa_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:400px\" colspan=\"2\">&nbsp;</TD>\n";
	$csa_new_form .= "        </TR>\n";
	$csa_new_form .= "      <TR>\n";
	$csa_new_form .= "        <FORM method=\"POST\" action=\"csarticle_upd.php\" target=\"_self\" name=\"editForm\" id=\"editForm\" enctype=\"multipart/form-data\">\n";
	$csa_new_form .= "        <TD class=\"td_cm\" style=\"width:250\"><input type=\"radio\" name=\"csa_stat\" value=\"1\" {$csa_statFlg1}>表示<input type=\"radio\" name=\"csa_stat\" value=\"9\" {$csa_statFlg2}>非表示</TD>\n";
	$csa_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:400;text-align:right;\" colspan=\"2\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"新規作成\" class=\"btn_csarticle\" onclick=\"return CsarticleInputCheck( this.form , this.form )\"/><input type=\"reset\" value=\"クリア\" class=\"btn_csarticle\" ></TD>\n";
	$csa_new_form .= "      </TR>\n";
	$csa_new_form .= "        <TR>\n";
	$csa_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:350px\">画像</TD>\n";
	$csa_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:300px\">タイトル</TD>\n";
	$csa_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:100px\">表示順</TD>\n";
	$csa_new_form .= "        </TR>\n";
	$csa_new_form .= "      <TR>\n";
	...
	$csa_new_form .= "      </TR>\n";
	$csa_new_form .= "        <TR>\n";
	$csa_new_form .= "          <TD colspan=\"2\" class=\"td_csarticle_new\" style=\"width:400px\">コンテンツ</TD>\n";
	$csa_new_form .= "        </TR>\n";
	$csa_new_form .= "      <TR>\n";
	$csa_new_form .= "        <TD class=\"td_cm\" colspan=\"3\" style=\"width:400;align:center\"><textarea name=\"csa_contents\" rows=\"12\" cols=\"53\">{$csa_contents}</textarea></TD>\n";
	$csa_new_form .= "        <INPUT type=\"hidden\" name=\"mode\" value=\"NEW\" />\n";
	...
	for($i=0;$i<$intTotal;$i++){
		$csa_id = $obj2->csarticledat[$i]['csa_id'];
		$csa_clid = $obj2->csarticledat[$i]['csa_clid'];

		// 状態情報生成
		$csa_statFlg1 = "";
		$csa_statFlg2 = "";
		$dispnoClr = "";
		$csa_stat = $obj2->csarticledat[$i]['csa_stat'];
		if($csa_stat == 1){
		...
		$csa_title = $obj2->csarticledat[$i]['csa_title'];
		$csa_img = $obj2->csarticledat[$i]['csa_img'];
		$csa_imgorg = $obj2->csarticledat[$i]['csa_imgorg'];
		$csa_contents = $obj2->csarticledat[$i]['csa_contents'];
		$csa_dispno = $obj2->csarticledat[$i]['csa_dispno'];
		$csa_adminid = $obj2->csarticledat[$i]['csa_adminid'];
		$csa_insdate = $obj2->csarticledat[$i]['csa_insdate'];
		$csa_upddate = $obj2->csarticledat[$i]['csa_upddate'];
		$csa_deldate = $obj2->csarticledat[$i]['csa_deldate'];

		// 画像
		$csa_img_dir = $param_csarticle_img_path;
		$csa_img_arr["org"] = $csa_imgorg;
		$csa_img_arr["chk_in"] = "1";
		$csa_img_arr["width"] = "150";
		$csa_img_arr["height"] = "150";
		$csa_img_txt =  form_ImgDisp( "csa_img" , $csa_img_dir , $obj2->csarticledat[$i]["csa_img"] , "3" , $csa_img_arr );

		$viewData .= "      <table border=\"0\" style=\"border:solid thin\" rules=\"none\">\n";
		$viewData .= "      <TR>\n";
		$viewData .= "        <FORM method=\"POST\" action=\"csarticle_upd.php\" target=\"_self\" name=\"editForm{$i}\" id=\"editForm{$i}\" enctype=\"multipart/form-data\">\n";
		...
		$viewData .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:400;text-align:right;\" colspan=\"2\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"修正\" class=\"btn\"  onclick=\"return CsarticleInputCheck( this.form , this.form )\"/><INPUT type=\"button\" value=\"削除\" class=\"btn\" onclick=\"document.del_csarticle{$i}.submit();return false;\"/></TD>\n";
		$viewData .= "      </TR>\n";
		$viewData .= "      <TR>\n";
...
//		$viewData .= "        <TD class=\"td_cm\" style=\"width:350px\"><input type=\"file\" name=\"csa_img\"></TD>\n";
		...
		$viewData2 .= "<FORM name=\"del_csarticle{$i}\" action=\"csarticle_upd.php\" method=\"POST\">\n";
...
<HTML>
  <HEAD>
    ...
    <LINK rel="stylesheet" type="text/css" href="../share/css/csarticle.css" />
    <SCRIPT type="text/javascript" src="../share/js/csarticle.js"></SCRIPT>
  ...
  <BODY>
    <TABLE>
      <TR>
        <TD><IMG src="../share/images/csarticle_title.gif" alt="コース自由記事登録" /></TD>

        <FORM ACTION="csarticle_select.php" METHOD="POST">
        <TD>
          <?=$csa_title_img?>
        </TD>
        </FORM>
        <FORM ACTION="csarticle_main.php" METHOD="POST">
        <TD>
          <input type="hidden" name="cs_id" value="<?=$_POST['cs_id']?>">
          <input type="submit" value="コース自由記事 小見出し登録へ戻る" style="width:300px;" class="btn">
        </TD>
        </FORM>
      </TR>
    </TABLE>
    <HR color="#96BC69" />
    <DIV id="title2">■コース自由記事登録</DIV>
<?=$csa_list_title?>
<?=$viewData?>
<br>
<?=$csa_new_form?>
