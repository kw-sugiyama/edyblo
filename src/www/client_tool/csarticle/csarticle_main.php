...
*/
	...
	**************************************/
	...
	$obj_cate->jyoken["cg_clid"] = $_POST['cs_id'];
	...
	$cg_new_form = "";
//	$cg_new_form .= "        <img src=\"../share/images/csarticle_new_button.gif\" alt=\"こちらをクリックすると展開表示できます\" width=\"100\" height=\"20\" title=\"詳細条件検索で絞り込む\" />\n";
...
//	$cg_new_form .= "      <br>\n";
	...
	$cg_new_form .= "        <TR>\n";
	$cg_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:120px\">状態</TD>\n";
	$cg_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:300px\">コース自由記事 小見出し</TD>\n";
	$cg_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:100px\">表示順</TD>\n";
	$cg_new_form .= "          <TD class=\"td_csarticle_new\" style=\"width:300px\">&nbsp;</TD>\n";
	$cg_new_form .= "        </TR>\n";
	$cg_new_form .= "      <TR>\n";
	$cg_new_form .= "        <FORM method=\"POST\" action=\"cscategory_upd.php\" target=\"_self\" name=\"editForm\" id=\"editForm\" enctype=\"multipart/form-data\">\n";
...
//	$cg_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"カテゴリ登録\" class=\"btn_csarticle\" onclick=\"return CscategoryInputCheck( this.form , this.form )\"/></TD>\n";
	$cg_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:300\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"小見出し登録\" class=\"btn_csarticle\" onclick=\"return CscategoryInputCheck( this.form , this.form )\"/><input type=\"reset\" value=\"クリア\" class=\"btn_csarticle\" ></TD>\n";
//	$cg_new_form .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:200\"></TD>\n";
	$cg_new_form .= "      <input type=\"hidden\" name=\"cg_type\" value=\"7\">\n";
	$cg_new_form .= "      <input type=\"hidden\" name=\"cs_id\" value=\"{$_POST['cs_id']}\">\n";
...
//	$cg_new_form .= "      </div>\n";
	...
	$cg_list_title .= "          <TD class=\"td_cl\" style=\"width:300px\">コース自由記事 小見出し</TD>\n";
	...
	for($i=0;$i<$intTotalCate;$i++){
		...
		// 画像
		$cg_img_dir = $param_csarticle_img_path;
		...
		$viewData .= "      <TR>\n";
		$viewData .= "        <FORM method=\"POST\" action=\"cscategory_upd.php\" target=\"_self\" name=\"editForm{$i}\" id=\"editForm{$i}\" enctype=\"multipart/form-data\">\n";
...
//		$viewData .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"カテゴリ修正\" class=\"btn\"  onclick=\"return CscategoryInputCheck( this.form , this.form )\"/></TD>\n";
		$viewData .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:300\" colspan=\"3\"><INPUT type=\"button\" name=\"go_mnt_2\" value=\"小見出し修正\" class=\"btn\"  onclick=\"return CscategoryInputCheck( this.form , this.form )\"/><INPUT type=\"button\" value=\"削除\" class=\"btn\" onclick=\"document.del_csarticle{$i}.submit();return false;\"/><INPUT type=\"button\" value=\"自由記事\" class=\"btn\" onclick=\"document.article_csarticle{$i}.submit();return false;\"/></TD>\n";
//		$viewData .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"></TD>\n";
//		$viewData .= "        <TD class=\"td_cm\" align=\"right\" style=\"width:100\"></TD>\n";
		$viewData .= "      <input type=\"hidden\" name=\"cg_type\" value=\"7\">\n";
...
//		$viewData .= "      </TR>\n";
		...
		$viewData2 .= "<FORM name=\"article_csarticle{$i}\" action=\"csarticle_mnt.php\" method=\"POST\">\n";
		...
		$viewData2 .= "      <input type=\"hidden\" name=\"cg_type\" value=\"7\">\n";
		$viewData2 .= "      <input type=\"hidden\" name=\"mode\" value=\"EDIT\">\n";

		$viewData2 .= "</FORM>\n";

		$viewData3 .= "<FORM name=\"del_csarticle{$i}\" action=\"cscategory_upd.php\" method=\"POST\">\n";
		...
		$viewData3 .= "      <input type=\"hidden\" name=\"cg_type\" value=\"7\">\n";
...
<HTML>
  <HEAD>
    ...
    <SCRIPT type="text/javascript" src="../share/js/courcecategory.js"></SCRIPT>
  ...
  <BODY>
    <TABLE>
      <TR>
        <TD><IMG src="../share/images/course_small_title.gif" alt="コース自由記事用 小見出し登録" /></TD>
        <FORM ACTION="csarticle_select.php" METHOD="POST">
        <TD>
          <?=$cg_stitle_img?>
        </TD>
        </FORM>
        <FORM ACTION="../course/course_main.php" METHOD="POST">
        <TD>
          <input type="submit" value="コース自由記事見出し一覧へ戻る" style="width:300px;" class="btn">
    ...
    <HR color="#96BC69" />
    <DIV id="title2">■コース自由記事用 小見出し登録</DIV>
<br>
<?=$cg_new_form?>
<br><br>
<?=$cg_list_title?>
