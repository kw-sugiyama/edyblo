...
require_once( SYS_PATH."php/disp_campaignapplyconfirm.php" );
require_once( SYS_PATH."php/disp_confirm_form.php" );
...
require_once( SYS_PATH."templates/campaignapplyconfirm.tpl" );
